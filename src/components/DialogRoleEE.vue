  ...
  <transition name="fade" @after-enter="isDialogShow = true">
    ...
    >
      ...
      <img
        ...
        ref="icon"
        class="dialog-icon"
        src="@/assets/images/icon/ic_continue_team1.svg"
        alt="ic_continue"
      />
    </div>
  </transition>
...
.dialog {
  &-wrapper {
    ...
    box-shadow: 0px 0px 24px 8px #ffc700, 0px 0px 8px 8px #ffc700;
  ...
  &-talk {
    ...
    &-bg {
      ...
      height: 100%;
      z-index: -1;
      background: var(--role-team1-linear), var(--bg-dark-60);
      border: 2px solid var(--role-team1);
      border-radius: 40px;
    }
  }
  &-icon {
